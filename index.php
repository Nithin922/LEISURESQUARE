	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>LIESURE SQUARE</h2>
				<p>One Of The Best Place For Grub And Wine</p>
				<br><br>
				<center>
		...
		<!-- One -->
			<section id="one" class="wrapper style1 align-center">
				<div class="container">
					<header>
						<h2>LIESURE SQUARE</h2>
						<p>Make Your Party With Your Delicious Dishes</p>
					</header>
					<div class="row 200%">
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">LIESURE SQUARE &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">We at Leisure Square Grub & Wine would Love to Serve Yor Yummy Dishes Straight From 
		Our Kitchen Ready For You.</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Leisure Square Fam<span>Bengaluru</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">6366304818</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:leisuresquare8384@gmail.com" style="color:white">leisuresqaure8384@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About LIESURE SQUARE</b></span>
				We believe passionately in great bargains and excellent service, which is why we commit ourselves to give you the best of both.
			</p>
								...
								<div class="row uniform 50%">
									...
									<div class="row uniform">
				                        ...
				                        <div class="3u 12u$(small)">
				                            <input type="radio" id="admin" name="category" value="1" checked>
