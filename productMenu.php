	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
						<h2>Welcome to Leisure Square</h2>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="wine" style="color: black;">Wine</option>
				...
				<?php
				    ...
				    if(isset($_GET['type']) AND $_GET['type'] == "wine")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'wine'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "non veg")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'non veg'";
					}
					if(isset($_GET['type']) AND $_GET['type'] == "veg")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'veg'";
					}
