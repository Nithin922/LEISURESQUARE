					  ...
					  <div class="col-sm-6">
						  <div class="select-wrapper" style="width: auto" >
							  <select name="type" id="type" required style="background-color:white;color: black;">
								  ...
								  <option value="Fruit" style="color: black;">Wine</option>
								  <option value="Vegetable" style="color: black;">Non veg</option>
								  <option value="Grains" style="color: black;">Veg</option>
							  </select>
						</div>
					  </div>
					  <div class="col-sm-6">
